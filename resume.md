...
<div id="print">
    <div class="col-lg-8 mx-auto">
        <h2>莫丹</h2>
        <p>女 ｜ 本科 ｜8kutan@gmail.com </p>
        <div class="area">
            <p>You can have the best looking app, but if it doesn't work, NO ONE is going to use it. </p>
            <p>终身学习者。</p>
            <p>8 年交互设计经验，形成自己的产品设计方法论并在公司中有所实践；坚持以人为本，掌握 SQL、 Python 等分析工具的使用，仍在不断学习；重点研究社会学，生物学，心理学；关注经济学，认知科学，数据分析等领域。</p>
        </div>
        <ul class="timeline">
            <li class="timeline-item">
                <div class="timeline-info">
                    <span>2022.4—2023.5 高级UX设计师</span>
                </div>
                ...
                <div class="timeline-content">
                    ...
                    <ul>
                        ...
                        <li>和海外设计顾问团队积极配合，定期展开设计workshop，为产品提出多个创意且实际的解决方案并推行</li>
